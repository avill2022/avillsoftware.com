            ...
            <div class="grid gap-4 py-4">
                ...
                <div class="grid grid-cols-4 items-center gap-4">
                    <label
                        ...
                        for="name_user_modal">Nombre</label>
                    <input
                        ...
                        id="name_user_modal" name="name" required="" value="">
                </div>
                <!--Email-->
                <div class="grid grid-cols-4 items-center gap-4">
                    <label
                        id = "email"
                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-white text-right"
                        for="email_user_modal">Correo</label>
                    <input
                        type="email"
                        class="flex h-12 w-full rounded-lg border border-white/20 bg-white/10 backdrop-blur-sm px-4 py-3 text-sm text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 col-span-3"
                        id="email_user_modal" name="email" required="" value="">
                </div>
                <!--Password-->
                <div class="grid grid-cols-4 items-center gap-4">
                    <label
                        id = "password_user_modal_label"
                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-white text-right"
                        for="password_user_modal">Contraseña</label>
                    <input
                        type="password"
                        class="flex h-12 w-full rounded-lg border border-white/20 bg-white/10 backdrop-blur-sm px-4 py-3 text-sm text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 col-span-3"
                        id="password_user_modal" name="password" required="" value="">
                </div>
                <!--Password repeat-->
                <div class="grid grid-cols-4 items-center gap-4">
                    <label
                        id = "password_repeat_user_modal_label"
                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-white text-right"
                        for="password_repeat_user_modal">Repite la contraseña</label>
                    <input
                        type="password"
                        class="flex h-12 w-full rounded-lg border border-white/20 bg-white/10 backdrop-blur-sm px-4 py-3 text-sm text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 col-span-3"
                        id="password_repeat_user_modal" name="password" required="" value="">
                </div>
                <!--Type-->
                <div class="grid grid-cols-4 items-center gap-4">
                    <label
                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-white text-right"
                        for="type_user_modal">Typo</label>
                        <!--<textarea
