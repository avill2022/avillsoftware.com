<?php
	...
	function get_item($id,$coursename,$description,$instructor,$type):string{
		return '<tr class="border-b border-white/10 hover:bg-white/5 transition-colors">
							<td class="p-4">'.$id.'</td>
                            <td class="p-4">'.$coursename.'</td>
                            <td class="p-4 text-white/70">'.$description.'</td>
                            <td class="p-4 text-white/70">'.$instructor.'</td>
							<td class="p-4 text-white/70">'.$type.'</td>
                            <td class="p-4 text-right">
							    <button
									onclick="javascript:toggle_menu_course(menu_course'.$id.')"
									...
									<div>
										...
										<div
											...
											<div data-side="bottom" data-align="center" role="menu" aria-orientation="vertical" data-state="open"
												...
												<div 
													id="edit_course'.$id.'"
													onclick="javascript:modal_edit_course('. $id .','.'\'' . addslashes($coursename) .'\','.'\'' . addslashes($instructor) .'\',\'' . addslashes($description) .'\')"
													role="menuitem"
												...
												<div id="delete_course'.$id.'"
													onclick="javascript:delete_course('.$id.')"
													role="menuitem"
		...
		if ($result){
			...
			$table='<div style="opacity: 1; transform: none;">
				<div class="flex justify-between items-center mb-8">
					...
					<button
						id="modal_course"
						onClick="javascript:modal_insert_course()"
